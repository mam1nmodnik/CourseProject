...
<nav class="sidebar">
    ...
    <div class="admin_logo_container">
        ...
        <img src="../img/Vector 1 (Stroke).svg" alt="" id="button-img" class="imgRotate">
    ...
    <div class="menu">
      ...
      <ul>
        ...
        <li><img src="../img/ArrowLineRight2.svg" alt=""><a href="donationsAdminPanel.php">Пожертвования</a></li>
